...
<div class="page-wrapper">
            ...
            <div class="about-content-v2">
                ...
                <ul class="contact-links-info">
                    ...
                    <li>
                        ...
                        <a href="#" title="">glance@team.com</a>
                    </li>   
                    <li>
                        <div class="ct-icon">
    ...
    <section class="map-section-full">
        <div class="container">
            <iframe height="600" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=1%20Grafton%20Street,%20Dublin,%20Ireland+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
        </div>
    </section>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-submit">
                            <button type="submit" class="theme-btn v2">send</button>
                        </div>
                    </div>
                </div>
            </form>

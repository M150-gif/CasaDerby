    ...
    <section class="cart-page">
        <div class="container">
            <div class="cart-content">
                <div class="top-msg">
                    Please, hurry! Someone has placed an order on one of the items you have in the cart. We'll keep it for you for 00:24 minutes.
                </div>
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <td>
                                        <div class="cart_product">
                                            <div class="cart_product_thumb">
                                                <img src="https://placehold.co/103x119" alt="" />
                                            </div>
                                            <div class="cart_product_info">
                                                <span class="pro-category">short one piece</span>
                                                <h3><a href="#" title="">Women's summer wrap v neck dress</a></h3>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="coupan-code">
                                            ...
                                            <div class="input-field">
                                                <input type="text" name="coupann" placeholder="Enter Coupon Code" />

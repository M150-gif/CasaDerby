...
<div class="page-wrapper">
    ...
    <section class="page-banner">
        <div class="container">
            <div class="page-banner-content text-center">
                <h2 class="page-title">Latest article </h2>
            ...
            <div class="blog-page-content">
                ...
                <div class="trending-column">
                    ...
                    <div class="trending-posts">
                        ...
                        <ul class="td-posts">
                            <li>
                                <h3 class="post-title"><a href="#" title="">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut finibus nibh arcu, faucibus bibendum arcu congue ut. </a></h3>
                                <ul class="meta">
                                    <li>
                                        <img src="images/icons/icon5.svg" alt="">
                                        <a href="#" title="">08 July 2022</a>
    ...
    <section class="top-match-section">
        <div class="container-fluid">
            <div class="sec-title">
    ...
    <section class="blog-posts-section-v3">
        <div class="container-fluid">
            <div class="blog-posts-v3">
                <div class="blog-posts-left-content">
                    <div class="blog-posts">
                        <div class="post">
                            <div class="post-thumb">
                                <img src="https://placehold.co/574x370" alt="">
                            </div>
                            <div class="post-info">
                                <h3><a href="#" title="">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut finibus nibh arcu, faucibus bibendum arcu congue ut. </a></h3>
                                <ul class="meta">
                                    <li>
                                        <img src="images/icons/icon5.svg" alt="">
                                        <a href="#" title="">08 July 2022</a>
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam est quam, semper at nisi ac, tristique fermentum lectus.</p>
                            </div>
                        </div><!--post-->
                        <div class="post">
                            <div class="post-thumb">
                ...
                <div class="blog-posts-right-sidebar">
                    <h3 class="widget-title">Continue reading</h3>
                    <div class="blog-posts">
                        <div class="post">
                            <div class="post-thumb">
                                <img src="https://placehold.co/498x322" alt="">
                            </div>
                            <div class="post-info">
                                <h3><a href="#" title="">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut finibus nibh arcu, faucibus bibendum arcu congue ut. </a></h3>
                                <ul class="meta">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam est quam, semper at nisi ac, tristique fermentum lectus.</p>
                                <a href="#" title="" class="theme-btn v2 full">Continue</a>
                            </div>
                        </div><!--post-->
                    </div>
                    <div class="blog-add">
                        <img src="https://placehold.co/498x539" alt="" />
                        <div class="blog-add-info">
                            <h3><a href="#" title="">Top match for you</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam est quam, semper at nisi ac.</p>
                            ...
                            <div class="product-hover-info">
                                ...
                                <div class="product-info-hover">
                                    ...
                                    <ul class="pro-buttons">
                                        ...
                                        <li><a href="#" title="" class="theme-btn">quick view</a></li>
                                    </ul>
                                </div>

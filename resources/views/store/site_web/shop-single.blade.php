...
<div class="page-wrapper">
    ...
    <div class="size-popup">
        ...
        <div class="size-chart">
            <img src="https://placehold.co/324x346" alt="" />
            <table>
                <tbody>
                    <tr>
                        <td>size</td>
                ...
                <div class="col-xl-7">
                    <div class="row th-images">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                            <div class="th-image">
                                <img src="https://placehold.co/422x664" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                            <div class="th-image">
    ...
    <section class="images-section">
        <div class="container-fluid">
            <div class="images-sec">
                <div class="image-col">
                    <img src="https://placehold.co/370x613" alt="" />
                </div>
                <div class="image-col">
                    <img src="https://placehold.co/370x613" alt="" />
                </div>
                ...
                <div class="image-col">
                    <img src="https://placehold.co/1333x2000" alt="" />
                </div>
                <div class="image-col">
                    <img src="https://placehold.co/1333x2000" alt="" />
                </div>
                ...
                <div class="col-lg-6">
                    <div class="blog_post">
                        <div class="blog_post_thumb">
                            <img src="https://placehold.co/570x367" alt="" />
                        </div>
                        <div class="blog_post_info">
                            <h3><a href="#" title="">Light Grey Hooded Jacket</a></h3>
                            <p>Vestibulum dignissim imperdiet nunc, mollis gravida sapien ornare eu. Nunc luctus fermentum est. Proin mi dolor, gravida non erat at, eleifend tincidunt mauris. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum pretium nisi orci, id bibendum</p>
                        </div>
                    </div><!--blog_post-->
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="reviews">
                        <div class="review-user">
                            <div class="review-user-img">
                                <img src="https://placehold.co/132x132" alt="" />
                            </div>
                        ...
                        <div class="review-info">
                            <p>“Lacus vulputate ac. Vivamus pellentesque, urna scelerisque accumsan placerat, nisi nunc vehicula lorem, quis vulputate ante sem consectetur ipsum. Aenean elementum efficitur libero, rhoncus laoreet felis faucibus a. Nullam ut euismod libero. Cras ante tortor, malesuada a purus vitae”</p>
                        </div>
                    </div>
                </li>
                <li>

    ...
    <section class="blog-single">
        <div class="container">
            <div class="blog-post-single">
                <img class="main-single-image" src="https://placehold.co/1170x528" alt="" />
                <div class="post-info">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam est quam, semper at nisi ac, tristique fermentum lectus. Praesent sit amet metus et ipsum malesuada blandit id eget velit. Praesent vehicula diam finibus imperdiet dignissim. Vestibulum non lectus eu neque congue euismod. Duis vel lorem consectetur, faucibus urna placerat, mollis dolor. Fusce orci felis, efficitur sed dapibus quis, sollicitudin a velit. Cras a nunc a eros semper porttitor. Maecenas molestie magna sit amet velit facilisis pulvinar. </p>
                    <p>Quisque sagittis risus purus, non lacinia nulla congue non. Etiam in orci egestas neque ultrices tincidunt. Nulla et nunc nunc. In hac habitasse platea dictumst. Ut eget auctor magna. Aliquam ex lacus, rutrum vitae neque vel, ultricies efficitur diam. Praesent efficitur justo eget nisl egestas, sed fringilla ante bibendum. Quisque quis iaculis risus. Sed semper magna sollicitudin leo cursus, a rhoncus enim tincidunt. Integer eu tortor ac risus tincidunt semper. Sed orci risus, blandit a dui id, luctus imperdiet sem. Nam aliquet, leo ac lobortis elementum, lacus velit malesuada risus, et faucibus mauris tellus eget turpis.</p>
                </div>
                <blockquote>
                    <p>Donec ullamcorper, dolor a suscipit pellentesque, justo mi facilisis quam, a ornare justo risus et felis. Morbi bibendum dapibus dapibus. Morbi euismod, leo sed sollicitudin porta, risus massa venenatis diam, sed efficitur </p>
                </blockquote>
                <div class="row bb-info">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <img src="https://placehold.co/570x315" alt="" class="mw-100" />
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In luctus leo sit amet lorem egestas iaculis. Donec nibh enim, pharetra vel turpis non, vulputate luctus ex. Phasellus pharetra ut dolor ac rutrum. Curabitur molestie nec mi in congue. Nam luctus ante quis urna molestie, ut venenati </p>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <img src="https://placehold.co/570x315" alt="" class="mw-100" />
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In luctus leo sit amet lorem egestas iaculis. Donec nibh enim, pharetra vel turpis non, vulputate luctus ex. Phasellus pharetra ut dolor ac rutrum. Curabitur molestie nec mi in congue. Nam luctus ante quis urna molestie, ut venenati </p>
                ...
                <img class="main-single-v2" src="https://placehold.co/1170x356" alt="" />
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam est quam, semper at nisi ac, tristique fermentum lectus. Praesent sit amet metus et ipsum malesuada blandit id eget velit. Praesent vehicula diam finibus imperdiet dignissim. Vestibulum non lectus eu neque congue euismod. Duis vel lorem consectetur, faucibus urna placerat, mollis dolor. Fusce orci felis, efficitur sed dapibus quis, sollicitudin a velit. Cras a nunc a eros semper porttitor. Maecenas molestie magna sit amet velit facilisis pulvinar.</p>
                    ...
                    <div class="swiper-slide">
                        <div class="post">
                            <div class="post-thumb">
                                <img src="https://placehold.co/350x312" alt="" />
                            </div>
                            <div class="post-info">

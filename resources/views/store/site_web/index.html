...
<div class="page-wrapper home1">
    ...
    <div class="search-box">
        <div class="search-box-content">
            ...
            <a href="#" title="" class="close-search"><img src="images/icons/close3.svg" alt="" /></a>
        </div>
    </div>
            ...
            <div class="row align-items-center">
                <div class="col-xl-5">
                    <div class="about-text">
                        <h3 class="title wow fadeInUp" data-wow-duration="2s" data-wow-delay="400ms"><span>GLANCE</span> Themes are compatible with major plugins and much more!</h3>
                        <p class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="700ms">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In luctus leo sit amet lorem egestas iaculis. Donec nibh enim, pharetra vel turpis non, vulputate luctus ex. Phasellus pharetra ut dolor ac rutrum. Curabitur molestie nec mi in congue. Nam luctus ante quis urna molestie, ut venenatis diam sagittis. Nam ligula velit, </p>
                        <a href="about.html" title="" class="theme-btn wow fadeInUp" data-wow-duration="2s" data-wow-delay="900ms">about me</a>
                    </div><!--about-text-->
                </div>
                <div class="col-xl-7 about-images">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                            <div class="abt-img wow fadeInUp">
                                <img src="https://placehold.co/330x520" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                            <div class="abt-img wow fadeInUp" data-wow-delay="300ms">
                                <img src="https://placehold.co/330x520" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                            <div class="abt-img wow fadeInUp" data-wow-delay="500ms">
                                <img src="https://placehold.co/330x520" alt="" />
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="lookboo-glance wow slideInUp">
                <div class="lookbook-slider">
                    <div class="lookbook">
                        <img src="https://placehold.co/1168x502" alt="" />
                    </div><!--lookbook-->
                    <div class="lookbook">
                        <img src="https://placehold.co/1168x502" alt="" />
                    </div><!--lookbook-->
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="product-cat">
                        ...
                        <h3><a href="#" title="">women clothes</a></h3>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="product-cat">
    ...
    <section class="trending-section">
        <div class="container-fluid">
            <div class="trending-products">
                <h1 class="tp-title wow fadeInUp">trending of the week</h1>
                <div class="row" data-masonry='{"percentPosition": true }'>
                    <div class="col-lg-4 col-md-4">
                        <div class="trending-product mb-150 wow fadeInLeft">
                            <img src="https://placehold.co/562x425" alt="" />
                            <div class="trending-product-hover">
                                <a href="#" title="" class="cart-product"><img src="images/heart.svg" alt="" /></a>
                                <h3><a href="shop-single.html" title="">Casual Jacket</a></h3>
                                <span class="price">$25.45</span>
                                <ul class="pd-btns">
                                    <li><a href="#" title="">quick add</a></li>
                                    <li><a href="#" title="">quick view</a></li>
                                </ul>
                            </div>
                        </div><!--trending-product-->
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="trending-product center wow fadeInUp" data-wow-delay="200ms">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="trending-product mb-150 wow fadeInRight" data-wow-delay="400ms">
                            <img src="https://placehold.co/562x425" alt="" />
                            <div class="trending-product-hover">
                                <a href="#" title="" class="cart-product"><img src="images/heart.svg" alt="" /></a>
                                <h3><a href="shop-single.html" title="">Casual Jacket</a></h3>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="trending-product wow fadeInUp" data-wow-delay="600ms">
                            <img src="https://placehold.co/562x425" alt="" />
                            <div class="trending-product-hover">
                                <a href="#" title="" class="cart-product"><img src="images/heart.svg" alt="" /></a>
                                <h3><a href="shop-single.html" title="">Casual Jacket</a></h3>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="trending-product wow fadeInUp" data-wow-delay="800ms">
                            <img src="https://placehold.co/562x425" alt="" />
                            <div class="trending-product-hover">
                                <a href="#" title="" class="cart-product"><img src="images/heart.svg" alt="" /></a>
                                <h3><a href="shop-single.html" title="">Casual Jacket</a></h3>
    ...
    <section class="featured-products-section">
        <div class="container-fluid">
            ...
            <div class="featured-products row">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="featured wow fadeInLeft" data-wow-delay="300ms">
                        <img src="https://placehold.co/562x822" alt="" />
                        <div class="featured-hover">
                            <span class="hvr"></span>
                            <div class="hvr-content">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="featured wow fadeInRight" data-wow-delay="500ms">
                        <img src="https://placehold.co/562x822" alt="" />
                        <div class="featured-hover">
                            <span class="hvr"></span>
                            <div class="hvr-content">
    ...
    <section class="banner-section">
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="sml-banner wow fadeInLeft">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="sml-banner wow fadeInRight">
                    <img src="https://placehold.co/944x614" alt="" />
                    <div class="banner-caption">
                        <h3>jewelry</h3>
                        <p>Lorem ipsum dolor sit consectetur adipiscing elit.</p>
    ...
    <section class="brand-section">
        <div class="container">
            ...
            <div class="row brands">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="brand-col wow fadeInLeft" data-wow-duration="300ms">
                        <div class="brand-head">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="brand-col wow fadeInLeft" data-wow-duration="500ms">
                        <div class="brand-head">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="brand-col wow fadeInLeft" data-wow-duration="700ms">
                        <div class="brand-head">
        ...
        <div class="col-lg-6 popup-content">
            <div class="inner-column">
                ...
                <form>
                    ...
                    <button type="submit" class="theme-btn v2 w-100">subscribe</button>
                </form>
            </div>
        </div>
    </div>

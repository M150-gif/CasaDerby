...
<!-- Stylesheets -->
<link href="{{asset('store/site_web/css/all.min.css')}}" rel="stylesheet">
<link href="{{asset('store/site_web/css/bootstrap.min.css')}}" rel="stylesheet">
<link href="{{asset('store/site_web/css/slick.css')}}" rel="stylesheet">
<link href="{{asset('store/site_web/css/slick-theme.css')}}" rel="stylesheet">
<link href="{{asset('store/site_web/css/swiper-bundle.min.css')}}" rel="stylesheet">
...
<div class="page-wrapper home1">
    ...
    <div class="popup coming-soon-popup">
        <a href="#" title="" class="close-popup">
            <img src="{{asset('store/site_web/images/close2.png')}}" alt="" />
            <h2>close</h2>
        </a>
        <div class="row">
    ...
    <section class="about-section-v2">
        <div class="container">
            <div class="about-content-v2">
                <h2>Style is the <img src="https://placehold.co/282x89" alt="" /> perfection  <img src="https://placehold.co/351x89" alt="" /> point of view <img src="https://placehold.co/351x89" alt="" /></h2>
                ...
                <div class="col-lg-4">
                    <div class="testi2-slide">
                        ...
                        <div class="testi2-info">
                            <img src="https://placehold.co/87x87" alt="" />
                            <h4>Arbaz Ali</h4>
                        </div>
                    </div><!--testi2-slide-->
                </div>
            ...
            <div class="trending-slider wow slideInUp">
                <div class="trending-slide">
                    <div class="trending-img">
                        <img src="https://placehold.co/1398x615" alt="" />
                        <div class="trending-caption-v2">
                            <div class="trending-thumb">
                                <img src="https://placehold.co/415x209" alt="" />
                            </div>
                            <h3><a href="shop-single.html" title="">Sunglasses</a></h3>
    ...
    <section class="collection-new">
        <div class="container-fluid">
            <div class="title-clt wow slideInUp">
                <h2>The joy <img src="https://placehold.co/282x89" alt="" /> of dressing <img src="https://placehold.co/282x89" alt="" /> is an art</h2>
            </div>
                        ...
                        <div class="circle-container">
                         ...
                         <div class="cart-product-slider-slide">
                            ...
                            <div class="cart-product-slide">
                                ...
                                images/product3.png" alt="" />
                            </div>
                        </div>
                    </div>
                    <div class="cart-slider-thumb wow slideInLeft">
                        <div class="cart-product-thumb-slide">
                            <img src="https://placehold.co/116x151" alt="" />
                        </div>
                        <div class="cart-product-thumb-slide">
                            <img src="https://placehold.co/1533x2300" alt="" />
                        </div>
                        <div class="cart-product-thumb-slide">
                            <img src="https://placehold.co/1533x2300" alt="" />
                        </div>
...
<script src="{{asset('store/site_web/js/slick-animation.min.js')}}"></script>
<script src="{{asset('store/site_web/js/popper.min.js')}}"></script>
<script src="{{asset('store/site_web/js/bootstrap.min.js')}}"></script>
<script src="{{asset('store/site_web/js/jquery.fancybox.js')}}"></script>
<script src="{{asset('store/site_web/js/wow.js')}}"></script>
<script src="{{asset('store/site_web/js/appear.js')}}"></script>
<script src="{{asset('store/site_web/js/swiper-bundle.min.js')}}"></script>
<script src="{{asset('store/site_web/js/jquery.marquee.min.js')}}"></script>

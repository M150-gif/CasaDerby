...
<div class="page-wrapper home1">
    ...
    <div class="popup coming-soon-popup">
        ...
        <div class="row">
            ...
            <img src="{{asset('store/site_web/images/product1.png')}}" alt="" />
            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="category-v2">
                                            <div class="category-v2-img">
                                                <img src="{{ asset('storage/' . $categorie->image_path) }}" alt="" />
                                            </div>
                                            <h3><a href="shop-single.html" title="">{{$categorie->nom}}</a></h3>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="col-lg-2">
                        ...
                        <div class="product-hover-info">
                            ...
                            <div class="product-info-hover">
                                <h3><a href="shop-single.html" title="">{{$product->prix}}</a></h3>
                        ...
                        <div class="product-info">
                            <h3><a href="shop-single.html" title="">{{$product->nom}}</a></h3>
                            <span class="product-price">{{$product->prix}} DH</span>
                        </div>
                    </div>
                </div>
                @endforeach
